...
- Milestone 1 document and presentation:
  ...
  <p><CourseInformationLink linkName='linkSubmitProjectMilestone1Document' /></p>

  <p><CourseInformationLink linkName='linkSubmitProjectMilestone1Slides' /></p>

- Milestone 1 presentation signup:

  <p><CourseInformationLink linkName='linkSignupProjectMilestone1Presentation' /></p>

- Milestone 2 document and presentation:

  <p><CourseInformationLink linkName='linkSubmitProjectMilestone2Document' /></p>

  <p><CourseInformationLink linkName='linkSubmitProjectMilestone2Slides' /></p>

- Milestone 2 presentation signup:

  <p><CourseInformationLink linkName='linkSignupProjectMilestone2Presentation' /></p>
