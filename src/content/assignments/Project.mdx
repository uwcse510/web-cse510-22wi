...
<p>
	<CourseInformationLink linkName="linkProjectProposalIdeas" />
</p>
...
<p>
	<CourseInformationLink linkName="linkProjectProposalSamples" />
</p>
...
<p>
	<CourseInformationLink linkName="linkProjectProposalGoogleDoc" />
</p>
...
<p>
	<CourseInformationLink linkName="linkSubmitProjectProposal" />
</p>
...
-   Milestone 1 document and presentation:
    ...
    <p>
    	<CourseInformationLink linkName="linkSubmitProjectMilestone1" />
    </p>

-   Milestone 1 presentation signup:

    <p>
    	<CourseInformationLink linkName="linkSignupProjectMilestone1Presentation" />
    </p>

-   Milestone 2 document and presentation:

    <p>
    	<CourseInformationLink linkName="linkSubmitProjectMilestone2" />
    </p>

-   Milestone 2 presentation signup:

    <p>
    	<CourseInformationLink linkName="linkSignupProjectMilestone2Presentation" />
    </p>
...
<p>
	<CourseInformationLink linkName="linkProjectCHIFormat" />
</p>

Additional guidance regarding effective paper writing can be found in:

<p>
	<CourseInformationFormattedReading readingName="readingWobbrockPaperWriting" />
</p>
...
<p>
	<CourseInformationLink linkName="linkSubmitProjectReport" />
</p>
