...
<h1 style={{marginTop: 0}}>Statistics Lab</h1>
...
<!--
The statistics lab will be made available for download <CourseInformationAssignmentDate assignmentDateName='assignmentDateAvailableStatisticsLab' />.
-->
